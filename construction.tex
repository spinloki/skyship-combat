...
\begin{itemize}
	...
	\item \listentry{Piercing (X)}{Target's armor is treated as X lower.}
...
\begin{itemize}
	...
	\item \modulelistentry{Wake Projector}{All \dicetype{\environmental} pools gain one additional die of the same type. The ship can spend 1 Power to restrict this effect to only 1 \dicetype{\environmental} pool.}{5}{2}
	...
	\item \modulelistentry{Targeting Scrambler}{Once per round, the ship can force its opponent in a Shooting Action to reroll an \dicetype{\attack}}{5}{2}
\end{itemize}